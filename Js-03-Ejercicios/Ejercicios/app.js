...
//* A partir de acá son los ejercicios que teníamos que entregar Profe! *
...
let calificaciones = [45, 72, 88, 53, 95, 67, 81, 60, 79, 99];
...
let precios = [15, 22, 45, 55, 10, 30, 75, 20, 50, 60];

for (let i = 0; i < precios.length; i++) {
    let precio = precios[i];
    if (precio < 20) {
        console.log(`Precio: $${precio} - Producto económico`);
    } else if (precio >= 20 && precio <= 50) {
        console.log(`Precio: $${precio} - Producto de precio moderado`);
    } else if (precio > 50) {
        console.log(`Precio: $${precio} - Producto de lujo`);
    }
}
